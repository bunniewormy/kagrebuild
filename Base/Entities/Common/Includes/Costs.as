...
namespace CTFCosts
{
	...
	s32 buildershop_wood, quarters_wood, knightshop_wood, archershop_wood,
		...
		tunnel_coins, quarry_stone, quarry_gold, quarry_count;
...
void InitCosts()
{
	...
	CTFCosts::tunnel_stone =                ReadCost(cfg, "cost_tunnel_stone"       , 150);
	CTFCosts::tunnel_wood =                 ReadCost(cfg, "cost_tunnel_wood"        , 100);
	CTFCosts::tunnel_gold =                 ReadCost(cfg, "cost_tunnel_gold"        , 50);
	CTFCosts::tunnel_coins =                ReadCost(cfg, "cost_tunnel_coins"       , 100);
