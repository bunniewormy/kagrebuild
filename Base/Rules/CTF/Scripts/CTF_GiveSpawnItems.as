...
void onRender(CRules@ this)
{
	...
	if (this.exists(propname)) {
		...
		GUI::DrawTextCentered(text, Vec2f(getScreenWidth() / 2, getScreenHeight() / 3 - 70.0f), color);
	}
	...
	if (name == "archer" && this.exists(propname)) {
		...
		GUI::DrawTextCentered(text, Vec2f(getScreenWidth() / 2, getScreenHeight() / 3 - 16.0f), color);
	}
